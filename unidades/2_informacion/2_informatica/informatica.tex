...
\begin{definition}\index{Archivo} Un \textbf{archivo informático} es la
...
\image{unidades/2_informacion/2_informatica/imagenes/file_icons_kde.png}
...
A continuación se presenta un listado con algunos de los formatos de archivo más
comunes que uno puede encontrar en el uso cotidiano:

\begin{minipage}[t]{0.3\textwidth}
    \subsubsection*{Fotos e imágenes:}
    \label{chap:informatica:subsubsec:imagenes}
...
\begin{minipage}[t]{0.3\textwidth}
    \subsubsection*{Audio:}
    \label{chap:informatica:subsubsec:audio}
...
\begin{minipage}[t]{0.3\textwidth}
    \subsubsection*{Video:}
    \label{chap:informatica:subsubsec:video}
...
\wraprimage[0.5]{unidades/2_informacion/2_informatica/imagenes/analogia_carpetas.png}
...
\begin{definition}\index{Directorio} Un \textbf{directorio} es la representación
...
Cada sistema operativo tiene su propio sistema de archivos, y su forma
...
En este sistema hay dos dispositivos de almacenamiento. Un disco extraible
...
Es menester mencionar algunos detalles sobre nomenclatura de rutas en diversos
...
Imaginemos ahora una serie de computadoras conectadas entre si. Es decir, una
...
\begin{definition}\index{URI}\index{Identificador de Recursos Universal} Un
...
\wraprimage[0.5]{unidades/2_informacion/2_informatica/imagenes/word.png}
...
\begin{definition}\index{Visualizador} Un \textbf{visualizador} es un programa
...
\begin{definition}\index{Editor} Un \textbf{editor} es un programa que permite
...
\wraplimage{unidades/2_informacion/2_informatica/imagenes/banderas.jpg}
...
Puede sonar complejo en la definición, pero utilizamos el lenguaje todo el
...
\index{Sintaxis}\index{Semántica} Todo lenguaje está compuesto de dos partes,
...
\begin{definition}\index{Lenguaje Formal} Un \textbf{lenguaje formal} es un
...
\wraprimage[0.5]{unidades/2_informacion/2_informatica/imagenes/tiobe_programming_languages.png}
...
\index{Compilador}\index{Compilar} Pero, si las computadoras trabajaban con
...
\index{Codigo Fuente@Código Fuente}\index{Codigo Objeto@Código Objeto} El
...
\begin{definition}\index{Compilador} Un \textbf{compilador} es un programa que
    transforma un archivo con código fuente en un archivo con código objeto,
    capaz de ser ejecutado en una computadora.
\end{definition}

\index{Interprete}\index{Interpretar} También existen algunos lenguajes que no
...
\begin{definition}\index{Interprete} Un \textbf{interprete} es un programa que
...
Es importante a tener en cuenta que, ni los compiladores ni los interpretes
...
\index{Lenguaje Compilado}\index{Lenguaje Interpretado} El lector puede o podría
...
\index{Lenguaje de Bajo Nivel}\index{Lenguaje de Medio Nivel}\index{Lenguaje de
Alto Nivel} Otra categorización que suele realizarse es la que diferencia
...
\index{Paradigma}\index{Paradigma Imperativo}\index{Paradigma Orientado a
Objetos}
...
\wraprimage[0.5]{unidades/2_informacion/2_informatica/imagenes/whatsapp.png}
...
Existen cientos de lenguajes de marcado, cada uno intentado resolver una
...
\begin{definition}\index{Lenguaje de Marcado} Un \textbf{lenguaje de marcado}
...
Pero ¿Para qué sirve un archivo de inicialización de Windows? Bien, tanto el
...
\begin{knowwhat}\index{Browsers} Casi todos los \textbf{browsers} permiten ver
...
\textbf{Markdown} es otro interesante lenguaje de marcado. Es ideal para
...
\index{Copyright}\index{Derecho de autor} Debe comprenderse que el software hoy
...
\image{unidades/2_informacion/2_informatica/imagenes/microsoft_barcelona.jpg}
{Oficinas de Microsoft en Barcelona.} {Imagen de T Magazine (The New York Times
Style Magazine: España).}

\index{Licencia}\index{Licenciatario}\index{Licenciante} Si bien un
...
\wraprimage{unidades/2_informacion/2_informatica/imagenes/licencia.png}
...
\begin{definition}\index{Shareware} El \textbf{shareware} consiste en software
...
\begin{definition}\index{Freeware} El \textbf{freeware} consiste en software que
...
\index{Software como Servicio}\index{SaaS} Con la masificación de Internet, es
...
\index{Software Libre}\index{Stallman, Richard} Previo al actual modelo
...
\begin{definition}\index{Software Libre} El \textbf{software libre} es aquel que
...
\begin{definition}\index{Software Propietario}\index{Software Privativo} El
...
\image{unidades/2_informacion/2_informatica/imagenes/flisol.jpg}
...
\index{GPL}\index{Copyleft} Estas libertades permiten teóricamente que los
...
\index{BSD}\index{MIT} Otras licencias aparecen a posteriori, como la licencia
...
\index{Linux}\index{Torvalds, Linus} El proyecto de Stallman de crear un sistema
...
\wraprimage{unidades/2_informacion/2_informatica/imagenes/linus_torvalds.jpg}
