\chapterimage{capitulos/historia_computadoras/imagenes/cover}
...
Y es que, a medida que avanza la ciencia y la técnica, también avanza la necesidad
...
\index{Abaco@Ábaco}\index{Suanpan}
...
\wraprimage{capitulos/historia_computadoras/imagenes/suanpan.jpg}
...
\index{Binario}\index{Sistema Binario}
...
\image{capitulos/historia_computadoras/imagenes/human_computers.jpg}
...
A medida que la ciencia avanzaba, se volvía necesario muchas veces realizar
...
\index{Pascal, Blaise}\index{Pascalina}
...
\index{Leibniz, Gottfried}\index{Leibniz, Cilindro de}\index{Cilindro de Leibniz}
Era una pequeña caja de madera que tenía en la tapa una hilera de discos
...
\index{Babbage, Charles}\index{Maquina Diferencial@Máquina Diferencial}
...
\index{Babbage, Charles}\index{Maquina AnalíticaMáquina Analítica}
...
\index{Jaquard, Joseph Marie}\index{Tarjeta Perforada}
...
\wraplimage[0.25]{capitulos/historia_computadoras/imagenes/charles_babbage.jpg}
...
\index{Godel, Kurt@Gödel, Kurt}\index{Teorema de la Incompletitud@Teoréma de la Incompletitud}
...
La necesidad de comprender las implicancias del trabajo de Gödel llevaron
...
\wraprimage{capitulos/historia_computadoras/imagenes/turing_church.jpg}
{Alan Turing (izq.) y Alonzo Church (der.).}
{Fotografía de Dominio Público. Universidad de Princeton.}

\index{Turing, Alan}\index{Turing, Maquina de@Turing, Máquina de}\index{Maquina de Turing@Máquina de Turing}
...
\index{Church Turing, Tesis de@Church-Turing, Tésis de}\index{Tesis de Church Turing@Tésis de Church-Turing}
...
\index{Z1}\index{Z2}\index{Rele@Relé}
Considerado hoy el inventor de las computadoras modernas, Konrad Zuse diseño
...
\image{capitulos/historia_computadoras/imagenes/zuse_z3.jpg}
...
\index{Harvard Mark I}\index{ASCC}
No poco después aparece la primer computadora construida por \textbf{IBM},
...
\image{capitulos/historia_computadoras/imagenes/eniac.jpg}
...
\begin{knowwhat}\index{Debugging}\index{Debuggear}
...
\begin{definition}\index{Arquitectura de Computadora}
...
\index{Von Neumann, John}\index{Von Neumann, Arquitectura de} \index{Arquitectura
de Von Neumann}\index{Arquitectura de Harvard}\index{Harvard, Arquitectura de}
...
\image{capitulos/historia_computadoras/imagenes/pdp_11.jpg}
...
\wraprimage{capitulos/historia_computadoras/imagenes/punch_cards.jpg}
...
\wraplimage{capitulos/historia_computadoras/imagenes/intel_4004.jpg}
{Un procesador Intel 4004.}
{Fotografía de Thomas Nguyen.}

\index{Kilby, Jack S.}\index{Texas Instruments}\index{Chip}\index{Microchip}
...
\begin{definition}
    \index{Chip}\index{Microchip}\index{Circuito Integrado}
...
\index{SMP80/88}\index{Micral N}\index{Altair 8800}
...
\index{Intel 8080}\index{Z80}\index{Motorola 6800}
...
\index{Homebrew Computer Club}\index{Wozniak, Steve}\index{Jobs, Steve}\index{Apple}
El \textbf{Homebrew Computer Club}, uno de estos clubes de entusiastas más influyentes y
...
\image{capitulos/historia_computadoras/imagenes/homebrew.jpg}
...
\index{Gates, Bill}\index{Microsoft}
...
\index{ColecoVision}\index{Atari 2600}\index{Magnavox Odyssey}
...
\wraprimage{capitulos/historia_computadoras/imagenes/cpm.jpg}
{CP/M corriendo sobre un monitor de fósforo verde en una Sanco 8001.}
{Fotografía de Mspetch.}

\textbf{La mayoría de las primeras microcomputadoras no permitían al usuario hacer
...
\index{CP/M}\index{DOS}\index{Kildall, Gary}\index{MS-DOS}\index{PC}
...
\index{Macintosh}\index{Apple}\index{Apple Macintosh}\index{Windows}\index{Microsoft Windows}
\textbf{Apple} lanzaría en 1984 la \textbf{Apple Macintosh}, un modelo de
...
\begin{knowwhat}\index{XEROX PARC}
...
\begin{definition}\index{Licencia de Software}
...
\wraprimage{capitulos/historia_computadoras/imagenes/richard_stallman.jpg}
...
Se dice en general que el software es \textbf{libre} si sus creadores adhieren
...
\image{capitulos/historia_computadoras/imagenes/internet_submarine.png}
...
\image{capitulos/historia_computadoras/imagenes/linkedin_luc_legay.jpg}
...
de conducción ante situaciones inprevistas.\index{Cuarta Revolucion Industrial@Cuarta Revolución Industrial}
...
\wraprimage{capitulos/historia_computadoras/imagenes/ibm_quantum.jpg}
