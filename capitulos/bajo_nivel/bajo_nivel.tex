...
capitanes de barcos deberían saberlo para que podamos comunicarnos efectivamente).
...
\begin{definition}\index{Codigo@Código}
    ...
    parpadeos lumínicos, sonidos u otros) en información relevante para el
...
Es decir, cualquier tipo de elemento del que podamos querer hablar es susceptible
