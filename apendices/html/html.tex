\chapterimage{apendices/html/imagenes/cover}
...
\image{apendices/html/imagenes/browsers.png}
...
Observesé como esta forma de estructurar el contenido fácilita su lectura y
...
\includegraphics[scale=0.5]{apendices/html/imagenes/diario_2.png}
\end{exercise}
...
\includegraphics[scale=0.5]{apendices/html/imagenes/diario_3.png}
\end{exercise}
...
\begin{exercise}
Agregue en la cebecera una barra de navegación, que contenga una lista
no ordenada de enlaces a las secciones del sitio. Las mismas son:
Politica, Policiales, Deportes y Espectáculos.
El resultado debe ser como el siguiente:

\includegraphics[scale=0.3]{apendices/html/imagenes/diario_5.png}
\end{exercise}
...
corresponden cada una a un mundial distinto. Deben haber tres columnas, la pimera indicando en que lugar del mundo se realizó el evento, y la segunda y
...
\includegraphics[scale=0.65]{apendices/html/imagenes/tabla.png}
\end{exercise}