\chapterimage{anexos/1_lenguajes_marcado/2_html/imagenes/cover.jpg}
...
\image{anexos/1_lenguajes_marcado/2_html/imagenes/browsers.png}
...
\includegraphics[scale=0.5]{anexos/1_lenguajes_marcado/2_html/imagenes/diario_2.png}
\end{exercise}
...
\includegraphics[scale=0.5]{anexos/1_lenguajes_marcado/2_html/imagenes/diario_3.png}
\end{exercise}
...
\includegraphics[scale=0.3]{anexos/1_lenguajes_marcado/2_html/imagenes/diario_5.png}
\end{exercise}
...
\includegraphics[scale=0.65]{anexos/1_lenguajes_marcado/2_html/imagenes/tabla.png}
\end{exercise}